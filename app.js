const countdown = "1 september 2021"
...
let countdowFunc = () => {
    ...
    const minutes = Math.trunc((timeLeft - days*24*3600*1000 - hours*60*60*1000)/60000);
    const seconds = Math.trunc((timeLeft - days*24*3600*1000 - hours*60*60*1000 - minutes* 60000) / 1000);
